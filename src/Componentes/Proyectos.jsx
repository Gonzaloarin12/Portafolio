...
const Tarjeta = ({ titulo, descripcion, enlaceGitHub }) => {
  return (
    <motion.div
      className="bg-gray-200 p-8 rounded-lg shadow-md text-center mb-8"
      whileHover={{ backgroundColor: '#F4F4F4' }} // Cambia el color al pasar el ratón sobre la tarjeta
    >
      <motion.img
        src={img}
        alt="proyecto"
        className="w-60 h-50 mb-4 mx-auto -full rounded-full "
        whileHover={{ scale: 1.1 }} // Animación de escala al pasar el ratón sobre la imagen
      />
...
const App = () => {
  return (
    <div className='bg-gray-800 text-white min-h-screen grid grid-cols-1 md:grid-cols-3 gap-10 items-center justify-center p-4 md:p-8'>
      <Tarjeta titulo="1) PORTAFOLIO " descripcion="Este mismo proyecto, para que puedan ver bien todo el código fuente." enlaceGitHub="https://github.com/Gonzaloarin12/Portfolio" />
